...
class MyModelsControllerTest < ActionController::TestCase
  ...
  test "should create my_model" do
    assert_difference('MyModel.count') do
      post :create, my_model: { field1: @my_model.field1, field2: @my_model.field2, field4: @my_model.field4, filed3: @my_model.filed3 }
    end
  ...
  test "should update my_model" do
    patch :update, id: @my_model, my_model: { field1: @my_model.field1, field2: @my_model.field2, field4: @my_model.field4, filed3: @my_model.filed3 }
    assert_redirected_to my_model_path(assigns(:my_model))
  end
